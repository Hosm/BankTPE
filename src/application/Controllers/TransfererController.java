 ...
 * @author MHY
 */
public class TransfererController implements Initializable, ControlledScreen{
	...
	@FXML
    private TextField afficheurtext,sendto;
	...
	public void deposer(){
		...
		int Numcompte=Integer.parseInt(sendto.getText());
		if(!comptecurrent.transferer(prix, Numcompte)){
